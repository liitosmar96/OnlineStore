drop table categoria if exists cascade constraints;
drop table producto if exists cascade constraints;
drop table puntuacion if exists cascade constraints;
